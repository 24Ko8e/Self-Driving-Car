...
public class NeuralNetwork : MonoBehaviour
{
    ...
    public void initialize(int hiddenLayerCount, int hiddenNeuronCount)
    {
        ...
        for (int i = 0; i < hiddenLayerCount + 1; i++)
        {
            ...
            Matrix<float> hidden1tohidden2 = Matrix<float>.Build.Dense(hiddenNeuronCount, hiddenNeuronCount);
            weights.Add(hidden1tohidden2);
        }
    ...
    public (float, float) runNetwork(float a,float b,float c)
    {
        ...
        //First value is acceleration and second value is steering
